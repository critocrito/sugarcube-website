...
- Using the `-p` option, you defined which plugins should be run (in this case, `http_import` and `tap_printf`). Note: _The order of the plugins matters_. You can't print results to the screen if you haven't fetched any results yet.
- Using the `-Q` option in your pipeline above, you specified the query for your website import.
...
To learn more about various aspects of Sugarcube look at the <a href="/docs/data-format">topical guides</a> that provide more in-depth information.
...
If you want to develop your own plugins read the guide about <a href="/docs/creating-plugins">authoring plugins</a>.
