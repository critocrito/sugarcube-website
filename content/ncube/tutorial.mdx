...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/workspace.gif" alt="Create a Ncube workspace." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/dashboard.gif" alt="The Ncube workspace dashboard." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/source.gif" alt="Creating a source." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/process.gif" alt="Setting up a process." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/exploration.gif" alt="Explore the data." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/search.gif" alt="Search the data." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/investigation.gif" alt="Create an investigation." />
...
<img class="ba b--bittersweet" src="../assets/ncube-tutorial/verification.gif" alt="Verify the data." />
