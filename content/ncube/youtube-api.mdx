...
![Create project for Youtube API](ncube/youtube-api/create-project.webp "Youtube API create project")

![New project for Youtube API](ncube/youtube-api/new-project.webp "Youtube API new project")
...
![Enable Youtube data API](ncube/youtube-api/enable.webp "Enable Youtube data API")

![Enable Youtube data API](ncube/youtube-api/enable2.webp "Enable Youtube data API")
...
![Create credentials for Youtube API](ncube/youtube-api/create-credentials.webp "Create Youtube API credentials")

![Create credentials for Youtube API](ncube/youtube-api/create-credentials2.webp "Create Youtube API credentials")

![Create credentials for Youtube API](ncube/youtube-api/create-credentials3.webp "Create Youtube API credentials")
